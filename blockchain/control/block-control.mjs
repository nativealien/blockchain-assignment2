...
export const mineBlock = async (req, res, next) => {
    ...
    console.log(process.env.MONGO_CHAIN_ID)
    ...
    // const result = await Chain.findOneAndUpdate({ _id: process.MONGO_CHAIN_ID }, { $set: { chain: pubnub.blockchain.chain}}, { new: true })

    console.log('MONGO',test, chain)
